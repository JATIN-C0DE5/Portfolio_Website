...
import Designn from './components/Designn';
    ...
    <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
      <div className="navbar-container">
        <div className="navbar-logo">
          <Link to="/">
            <span className="logo-text">J18Yadav</span>
        ...
        <div className={`navbar-links ${isMenuOpen ? 'active' : ''}`}>
          ...
          <Link to="/designn" className={`nav-link ${location.pathname === '/designn' ? 'active' : ''}`} onClick={handleLinkClick}>
            Design
          </Link>
      ...
      <div className={`app-container ${darkMode ? 'dark-mode' : ''}`}>
        ...
        <main className="content">
          <Routes>
            ...
            <Route path="/Designn" element={<Designn />} />
